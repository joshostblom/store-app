...
VALUES ('Lenovo IdeaPad 3 Laptop', 450.43, CAST('https://pisces.bbystatic.com/image2/BestBuy_US/images/products/6461/6461977ld.jpg' AS varbinary(max)), 1, 'SKU123', 4.5, 'New, Touchscreen, Comes with Charger and Pen, 16GB RAM', 'Lenovo Group of China', 15.0, 3.0, 6.0, 2.0),
       ...
       ('Samsung 4K Smart TV', 799.99, CAST('https://images.samsung.com/is/image/samsung/latin-en-uhdtv-nu7100-un50nu7100pxpa-frontblack-121432508?$1300_1038_PNG$' AS varbinary(max)), 2, 'SKU789', 4.8, '50-inch 4K UHD Smart TV, HDR, Crystal Display', 'Samsung Electronics', 27.0, 4.0, 44.0, 32.0),
       ...
       ('KitchenAid Stand Mixer', 349.99, CAST('https://cb.scene7.com/is/image/Crate/KitchenAidArtStMxACAVSSS21_VND/$web_pdp_main_carousel_med$/210323153457/kitchenaid-artisan-series-5-quart-tilt-head-almond-cream-stand-mixer.jpg' AS varbinary(max)), NULL, 'SKU112', 4.9, '5-Quart Tilt-Head Stand Mixer, Stainless Steel Bowl, 10-Speed Settings', 'Whirlpool Corporation', 14.1, 8.7, 14.1, 25.0),
       ('Apple AirPods Pro', 249.00, CAST('https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/refurb-airpods-2022?wid=572&hei=572&fmt=jpeg&qlt=95&.v=1673992683197' AS varbinary(max)), 1, 'SKU202', 4.9, 'Active Noise Cancellation, Sweat and Water Resistant, Wireless Charging Case', 'Apple', 1.2, 0.9, 2.4, 0.38),
       ...
       ('Adidas Ultraboost Running Shoes', 180.00, CAST('https://i.ebayimg.com/images/g/T10AAOSwevBjS-Mo/s-l500.png' AS varbinary(max)), 2, 'SKU428', 4.6, 'Responsive Running Shoes with Boost Cushioning', 'Adidas', 4.0, 7.5, 12.0, 1.0),
       ('LEGO Star Wars Millennium Falcon', 159.99, CAST('https://shop-newyork.legoland.com/cdn/shop/products/75257_1024x1024@2x.jpg?v=1614449862' AS varbinary(max)), 1, 'SKU537', 4.8, '1,351 Pieces, Buildable Millennium Falcon Set', 'The LEGO Group', 8.0, 33.2, 22.8, 4.0),
       ...
       ('Nike Golf Mens Dri-FIT Polo Shirt', 45.00, CAST('https://storagemedia.corporategear.com/storagemedia/1/mastercatalog/attributeimages/ci4470-448.jpg' AS varbinary(max)), 2, 'SKU753', 4.5, 'Moisture-Wicking, Breathable, Dri-FIT Technology', 'Nike Inc.', NULL, NULL, NULL, NULL),
       ('Kindle Paperwhite E-reader', 129.99, CAST('https://assets-global.website-files.com/60feafdac3e33ed6180205f3/618fea956c2e5705bca9c497_3eafacac.png' AS varbinary(max)), 2, 'SKU864', 4.5, '6-inch High-Resolution Display, Waterproof, 8GB', 'Amazon', 6.6, 4.6, 0.3, 6.4),
       ('Breville Smart Oven', 299.95, CAST('https://crdms.images.consumerreports.org/f_auto,w_600/prod/products/cr/models/392664-toasterovens-breville-smartovenairconvectionbov900bssusc.png' AS varbinary(max)), 1, 'SKU902', 4.9, '1800W Convection Toaster Oven, Element IQ Technology', 'Breville', 11.0, 18.5, 16.2, 20.0),
       ('Nike Air Zoom Pegasus 38 Running Shoes', 120.00, CAST('https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/968b68b3-826d-47b4-a714-e5594ace613d/air-zoom-pegasus-38-mens-road-running-shoes-lq7PZZ.png' AS varbinary(max)), 2, 'SKU903', 4.7, 'Responsive Running Shoes with Zoom Air Cushioning', 'Nike Inc.', 4.3, 7.8, 11.7, 0.65),
       ...
       ('Sony WH-1000XM4 Wireless Noise-Canceling Headphones', 348.00, CAST('https://i.ebayimg.com/images/g/TiAAAOSwnIRkgLG0/s-l1600.png' AS varbinary(max)), 1, 'SKU905', 4.6, 'Industry-Leading Noise Cancellation, Touch Sensor Controls', 'Sony Corporation', 9.9, 3.0, 7.3, 0.83),
       ('Cuisinart 14-Cup Food Processor', 229.95, CAST('https://crdms.images.consumerreports.org/f_auto,w_600/prod/products/cr/models/387449-foodprocessors-cuisinart-custom14dfp14bcny.png' AS varbinary(max)), NULL, 'SKU906', 4.7, 'Stainless Steel Blades, 14-Cup Capacity, Dough Blade', 'Cuisinart', 17.0, 10.0, 7.5, 18.0),
       ('GoPro HERO9 Black Action Camera', 449.99, CAST('https://coolstuf.com.pg/wp-content/uploads/2020/11/GOPRO-HERO9-main-1-2048x1540.jpg' AS varbinary(max)), 2, 'SKU907', 4.5, '5K Video, 20MP Photos, HyperSmooth 3.0', 'GoPro, Inc.', 2.3, 1.8, 1.5, 5.6),
       ...
       ('Hamilton Beach Coffee Maker', 39.99, CAST('https://crdms.images.consumerreports.org/f_auto,w_600/prod/products/cr/models/400768-drip-coffee-makers-with-carafe-hamilton-beach-programmable-alexa-smart-49350-10011102.png' AS varbinary(max)), 1, 'SKU909', 4.3, '12-Cup Programmable BrewStation, Dispensing Coffee Machine', 'Hamilton Beach Brands, Inc.', 13.9, 8.2, 14.4, 6.0),
       ('Fitbit Charge 4 Fitness and Activity Tracker', 149.95, CAST('https://helios-i.mashable.com/imagery/reviews/06l8zHGjxPvYrSnoDGq9W95/hero-image.fill.size_1248x702.v1641937211.png' AS varbinary(max)), 2, 'SKU910', 4.4, 'Built-In GPS, Heart Rate Monitoring, Sleep Tracking', 'Fitbit, Inc.', 1.4, 0.9, 0.5, 0.3);
