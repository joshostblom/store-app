...
To connect to your own database, navigate to the `appsettings.json` file and enter your database connection string as the value for the `"ShoppingAppCon"` key. The SQL scripts to create tables and dummy data can be found in the directory `store-app/Store-App/SQL_Scripts/`.
